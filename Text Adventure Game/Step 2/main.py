...
if direction == "1":
    print("\nYou have gone north. After a few miles you find a stone with a strange green glow. You pick up the stone and put it in your pocket.")
else:
    print("\nYou have gone south. Past a bend in the road, you find an abandoned hut. You decide to make the hut your home and explore the area around it.")
...
if attack == "1":
    ...
    print("\nYou step off the path, draw your sword and wait until the goblins are closer."
    ...
    print("\nYou step of the path and carefully walk deep into the forest.")

    if outcome_hiding < 2:
        print("The goblins haven't noticed a thing, you hear them pass as they talk loudly amongst themselves.")
    else:
        print("Apparently your scent has lingered on the path, you should have taken a bath.\nYou see one of the goblins sniff around and advancing towards you. The rest of the goblins follow excitedly.\nIt's no use to run and you aren't prepared to fight. You let yourself be taken captive and are taken to the leader of the goblins")
